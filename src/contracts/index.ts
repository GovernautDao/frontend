...
const IDENTITY_MANAGER_ADDRESS: `0x${string}` = "0x1C4cCc2c917EDF45aD1C3C9675cF130b47Db8c11";

const GOVERNAUT_GOVERNANCE_ADDRESS: `0x${string}` = "0x266Dd5675a773035DF4e23c4e95EA5De755B49E2";

const FUNDING_ADDRESS: `0x${string}` = "0xeA686366D6bB59e759fCAB5cBd7b94963bf291E6";
...
const GOVERNAUT_GOVERNANCE_ABI = [
  ...
  },
  {
    ...
    "inputs": [],
    "outputs": [
      { "name": "", "type": "address", "internalType": "contract IERC5805" }
    ],
    "stateMutability": "view"
  },
  {
...
const IDENTITY_MANAGER_ABI = [
  ...
  export const GOVERNAUT_GOVERNANCE_CONTRACT = {
    address: GOVERNAUT_GOVERNANCE_ADDRESS,
