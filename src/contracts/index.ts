import { metalL2Testnet } from '@/config/wagmi';
import { ContractAddressMap } from '@/interfaces/ContractAddressMap';
import { Abi } from 'viem';
import { baseSepolia } from 'viem/chains';

const IDENTITY_MANAGER_ADDRESS: `0x${string}` =
  '0xB80306c2417ab1cf39a69d8326C90A54b35992c0';

const FUNDING_ABI: Abi = [
  {
    type: 'constructor',
    inputs: [
      {
  ...
  { type: 'error', name: 'AllClaimsClaimed', inputs: [] },
  {
    type: 'error',
    name: 'GovernautGovernanceCantBeAddressZero',
    inputs: [],
  },
  { type: 'error', name: 'GrantGoalIsMet', inputs: [] },
  { type: 'error', name: 'GrantGoalNotMet', inputs: [] },
  { type: 'error', name: 'GrantHasEnded', inputs: [] },
  { type: 'error', name: 'GrantHasNotEnded', inputs: [] },
  { type: 'error', name: 'NoContributions', inputs: [] },
  { type: 'error', name: 'NotEnoughTimePassed', inputs: [] },
  { type: 'error', name: 'OnlyProjectOwnerCanClaim', inputs: [] },
  {
    type: 'error',
  ...
  { type: 'error', name: 'UserIsntAnApprovedProposer', inputs: [] },
];

const GOVERNAUT_GOVERNANCE_ABI: Abi = [
  {
    type: 'constructor',
    inputs: [
      {
  ...
  {
    type: 'error',
    name: 'IdentityManagerCantBeAddressZero',
    inputs: [],
  },
  {
    type: 'error',
  ...
  { type: 'error', name: 'UserIsntVerified', inputs: [] },
];
...
export const GOVERNAUT_GOVERNANCE_CONTRACT: ContractAddressMap = {
  [baseSepolia.id]: {
    address: '0xCCc01DB2A5260bBF4767586E89fE4e540cd9954C',
  },
  [metalL2Testnet.id]: {
    address: '0x266Dd5675a773035DF4e23c4e95EA5De755B49E2',
  },
  abi: GOVERNAUT_GOVERNANCE_ABI,
};

export const IDENTITY_MANAGER_CONTRACT = {
  address: IDENTITY_MANAGER_ADDRESS,
  abi: IDENTITY_MANAGER_ABI,
};

export const FUNDING_CONTRACT: ContractAddressMap = {
  [baseSepolia.id]: {
    address: '0x89F7868a9D66962906D29350C5957c1Ca5d8843b',
  },
  [metalL2Testnet.id]: {
    address: '0xeA686366D6bB59e759fCAB5cBd7b94963bf291E6',
  },
  abi: FUNDING_ABI,
};
